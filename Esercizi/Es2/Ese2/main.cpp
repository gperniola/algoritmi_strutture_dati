...
int main()
{
   ...
   // A[0].costrBinAlbero(A[1],A[2]);
    ...
    int z = odd(A[0], 2);
    cout << "odd numbers of level 2: " << z << endl;
    int y = even_nodes(A[0]);
    cout << "even nodes: " << y<< endl;
    int x = even_leafs(A[0]);
    cout << "even leafs: " << x<< endl;
    int v = leafs_with_even_parent(A[0]);
    cout << "leafs with even parents: " << v<< endl;
